...
public class GUIBuilder {
	 ...
	 * @param frame is the component to be set
	 */
    static public void loadBounds(java.awt.Component frame, String key, Application app) {
	 ...
	 */
    static public void saveBounds(java.awt.Component frame, String key, Application app) {
        // Look for saved settings
        SettingsManager settings = app.getSettings();
        SettingsManager.Element cfg = settings.getOrCreateElement(key);
