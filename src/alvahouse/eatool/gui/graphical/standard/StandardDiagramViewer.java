...
/**
 * This is the frame window for all diagram display and editing. This should be
 * subclassed and the correct ItemHandler supplied for the type of diagram.
 * 
...
public abstract class StandardDiagramViewer extends DiagramViewer {
	 ...
	 * @throws BSFException
	 */
	public StandardDiagramViewer(StandardDiagram diagram, ItemHandler itemHandler, Application app,
	...
	/**
	 * Gets the ItemHandler for this viewer. Allows type specific code to be used by
	 * generic handlers.
	 * 
	...
	/**
	 * Gets any GraphicalObject selected on the diagram. Note that this may be a
	 * symbol but will not be a Connector.
	 * 
	 * @return any selected GraphicalObject or <code>null</code> if nothing
	 *         selected.
	 */
	 ...
	 * 
	 * @return any selected Conenctor or <code>null</code> if no connector is
	 *         selected.
	 */
	...
	/**
	 * internal pane to hold the view of a model. This does the real display and
	 * editing work.
	 */
	public class ViewerPane extends JPanel {
		...
		/**
		 * Gets the current zoom factor. 1 is normal size, 0.5 half size, 2.0 double
		 * etc.
		 * 
