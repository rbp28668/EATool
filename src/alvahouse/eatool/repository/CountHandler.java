...
/**
 * CountHandler writes out, and reads in subsequently, counts of various components in the repository
 * to allow reasonable estimates of progress during loading.
 * 
 * @author rbp28668
 */
public class CountHandler implements IXMLContentHandler {
    ...
    public void writeXML(XMLWriter out) throws IOException {
        ...
        out.textEntity("MetaRelationshipCount",Integer.toString(repository.getMetaModel().getMetaRelationshipCount()));
    ...
    public void endElement(String uri, String local) throws InputException {
        if (local.equals("MetaEntityCount")){
            ...
            int total = metaEntityCount 
            + metaRelationshipCount
            + entityCount
            + relationshipCount
            + scriptCount
            + eventCount
