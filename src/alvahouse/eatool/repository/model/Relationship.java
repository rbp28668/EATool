...
public class Relationship extends PropertyContainer implements TooltipProvider, Versionable{
	 ...
	 */
    public Relationship(UUID uuid, MetaRelationship mr) {
        super(uuid);
	 ...
	 * @param mr is the corresponding meta-relationship.
	 */
    public Relationship(MetaRelationship mr) {
    	super(new UUID());
        addDefaultProperties(mr);
    	meta = mr;
...
//    }
    ...
    public String toString() {
        String decode = start().getMeta().getName() + ": " + start().connectsTo().toString() +
                 " related to " + finish().getMeta().getName()+ ": " + finish().connectsTo().toString();
        return decode; 
    }
...
//     */
//    public Object clone() {
//        Relationship copy = new Relationship(getKey(),getMeta());
//        cloneTo(copy);
//        return copy;
//    }
//    
...
//    }
   ...
   public void setFinish(Role r){
    ...
    /** determines whether 2 relationships are duplicates.  They are duplicates
     * if they have the same meta-relationship and their connected entities match
     */
    public boolean isDuplicate(Relationship other) {
        return (getMeta() == other.getMeta())
            && start().connectsTo().equals(other.start().connectsTo())
            && finish().connectsTo().equals(other.finish().connectsTo());
    }
...
//    }
	...
	/**
	 * gets the tooltip for this object when displayed in a gui or
	 * diagram.
